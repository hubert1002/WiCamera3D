...
public class Mosaic {
    ...
    static {
       System.loadLibrary("jni_wipanorama");
    }
    ...
    public native void allocateMosaicMemory3D(int width, int height,boolean is3D);
    /**
     * Free memory allocated by allocateMosaicMemory.
     *
     */
    public native void freeMosaicMemory3D(boolean is3D);
    ...
    public native float[] setSourceImage3D(byte[] pixels_l,byte[] pixels_r);
    /**
    ...
    public native int createMosaic3D(boolean value,boolean isleft);
    /**
